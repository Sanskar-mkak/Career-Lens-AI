      ...
      <div className={styles.contentWrapper}>
        ...
        <div className={styles.logoGrid} role="list">
          ...
          <div className={styles.logoItem} role="listitem">
            <svg width="32" height="32" viewBox="0 0 24 24" aria-label="Google" role="img" className={styles.logoIcon}>
              <path
                fill="#4285F4"
          ...
          {/* Microsoft */}
          <div className={styles.logoItem} role="listitem">
            <svg width="28" height="28" viewBox="0 0 22 22" aria-label="Microsoft" role="img" className={styles.logoIcon}>
          ...
          {/* Amazon */}
          <div className={styles.logoItem} role="listitem">
            <svg width="32" height="32" viewBox="0 0 24 24" aria-label="Amazon" role="img" className={styles.logoIcon}>
              <path
                fill="currentColor"
          ...
          {/* Meta */}
          <div className={styles.logoItem} role="listitem">
            <svg width="32" height="32" viewBox="0 0 24 24" aria-label="Meta" role="img" className={styles.logoIcon}>
              <path
                fill="#0668E1"
            ...
            <span className={styles.logoText}>Meta</span>
          </div>

          {/* Adobe */}
          <div className={styles.logoItem} role="listitem">
            <svg width="28" height="28" viewBox="0 0 24 24" aria-label="Adobe" role="img" className={styles.logoIcon}>
            ...
            <span className={styles.logoText}>Adobe</span>
          </div>

          {/* Apple */}
          <div className={styles.logoItem} role="listitem">
            <svg width="28" height="28" viewBox="0 0 24 24" aria-label="Apple" role="img" className={styles.logoIcon}>
              <path
                fill="currentColor"
            ...
            <span className={styles.logoText}>Apple</span>
          </div>
        </div>
      </div>
    </section>
