 ...
 *
 * Visual reference: Website Look/Login_Signup Page.png (Sign Up tab)
 */
...
function validateRegisterForm(fields: RegisterFormFields): RegisterFormErrors {
  ...
  if (!fields.agreedToTerms) {
    errors.agreedToTerms = 'You must agree to the Terms and Privacy Policy to continue.';
  }
...
export const RegisterPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // UI-only: validation passed. Account creation not yet implemented.
    setErrors({});
    setSubmitted(true);
  };
  ...
  return (
    <div className={styles.authPage}>
      ...
      <div className={styles.authBody}>
        {/* ── Left: Form Panel ── */}
        <section className={styles.formPanel} aria-label="Create account form">
          <div className={styles.formCard}>
            ...
            <p className={styles.subheading}>
              Start your journey to smarter career growth today.
            </p>

            {/* Success notice (UI-only — account creation not yet implemented) */}
            {submitted && (
              <div
                role="status"
                aria-live="polite"
              ...
              >
                ✓ Validation passed. Account creation backend not yet connected.
              </div>
            )}
            ...
            <form className={styles.form} onSubmit={handleSubmit} noValidate>
              ...
              <div className={styles.fieldGroup}>
                ...
                {errors.fullName && (
                  <span id="reg-name-error" className={styles.errorMsg} role="alert">
                    {errors.fullName}
                  </span>
                )}
              </div>
              ...
              <div className={styles.fieldGroup}>
                ...
                {errors.email && (
                  <span id="reg-email-error" className={styles.errorMsg} role="alert">
                    {errors.email}
                  </span>
                )}
              </div>
              ...
              <div className={styles.fieldGroup}>
                ...
                <div className={styles.inputWrapper}>
                  ...
                  <input
                    ...
                    aria-describedby="reg-password-hints"
                ...
                {fields.password.length > 0 && (
                  <div
                    id="reg-password-hints"
                    className={styles.passwordHints}
                    aria-label="Password requirements"
                  >
                    {PASSWORD_REQUIREMENTS.map((req) => {
                      const isMet = req.met(fields.password);
                      return (
                        <span
                          key={req.label}
                          className={`${styles.hintItem} ${isMet ? styles.hintMet : ''}`}
                          aria-label={`${req.label}: ${isMet ? 'met' : 'not yet met'}`}
                        >
              ...
              <div className={styles.fieldGroup}>
                ...
                {errors.confirmPassword && (
                  <span id="reg-confirm-error" className={styles.errorMsg} role="alert">
                    {errors.confirmPassword}
                  </span>
                )}
              </div>
              ...
              <div className={styles.fieldGroup}>
                <label className={styles.termsLabel}>
                  ...
                  <span>
                    I agree to the{' '}
                    {/* UI placeholders — legal pages not yet created */}
                    <button
                      type="button"
                      className={styles.termsLink}
                      onClick={(e) => e.preventDefault()}
                      aria-label="Terms of Service — page not yet available"
                    >
                      Terms of Service
                    </button>
                    {' '}and{' '}
                    <button
                      ...
                      className={styles.termsLink}
                      onClick={(e) => e.preventDefault()}
                      aria-label="Privacy Policy — page not yet available"
                    >
                      Privacy Policy
                    </button>
                  </span>
                ...
                {errors.agreedToTerms && (
                  <span id="reg-terms-error" className={styles.errorMsg} role="alert">
                    {errors.agreedToTerms}
                  </span>
                )}
              </div>
              ...
              {/*
               * Social buttons — UI PRESENTATION ONLY.
